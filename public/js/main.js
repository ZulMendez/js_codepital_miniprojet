...
let malade1 = new Malades('Marcus', 'mal indenté', 100, 'vide', 'malade');
let malade2 = new Malade('Marcus', 'mal indenté', 100, 'vide', 'malade');
let malade3 = new Malades('Sangoku', 404, 80, 'vide', 'malade');
let malade4 = new Malades('DarthVader', 'asthmatique', 101, 'vide', 'malade');
let malade5 = new Malades('Semicolon', 'syntaxError', 60, 'vide', 'malade');
